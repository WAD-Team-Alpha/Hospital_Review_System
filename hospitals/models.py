...
class Hospital(models.Model):
    ...
    Achievements3 = models.CharField(max_length=50, default="No Hospital information recently")
    Achievements4 = models.CharField(max_length=50, default="No achievements added recently")
    Achievements5 = models.CharField(max_length=50, default="No achievements added recently")
    Achievements6 = models.CharField(max_length=50, default="No achievements added recently")
    def __str__(self):
